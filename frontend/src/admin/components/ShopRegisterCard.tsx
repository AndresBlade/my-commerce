		...
		<article className="p-8 m-8 bg-gris rounded-2xl w-full overflow-hidden">
			<div className="flex items-center justify-between mb-4">
				<div className="flex flex-col mx-auto md:mx-0 md:flex-row items-center gap-4">
					<img
						className="w-32 h-32 mx-auto mb-2 md:w-60 md:h-60 object-contain rounded-full"
						src={shop.imagen}
						alt={shop.nombre}
					/>
					<div className="flex-col text-center md:text-left">
						...
						<h2 className="text-md md:text-lg font-normal">
							{shop.RIF}
						</h2>
					</div>
				</div>
				...
				<div className="hidden lg:flex gap-4 justify-center">
					<img
						className="w-16 md:w-24 h-16 md:h-24 object-contain bg-white p-2 rounded-lg"
						src={foto1}
						alt={shop.nombre}
					/>
					<img
