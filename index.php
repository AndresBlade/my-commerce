...
<body>
    <header class="header">
        ...
        <div class="group">
            ...
            <div class="search">
                <span class="icon">
                    <ion-icon name="search-outline" id="blanco" class="searchBtn"> </ion-icon>
    ...
    <main>
        ...
        <section class="box-container">
            <div class="box box-1" >
                ...
                <input type="button" value="Crea tu cuenta" class="btnCrearCuenta">
            </div>
            <div class="box box-2">
        ...
        <section class="tiendas-destacadas">
            ...
            <div class="box-container">
                ...
                <div class="box">
                    ...
                    <!-- imagen -->
                    <div class="inner-container texto">
                        ...
                        <div class="inner-box">
                            <h4>Categoria de la tienda: </h4>
                            <p>Artefactos de electronica</p>
                        </div>
                        <div class="inner-box">
                            <ul>
                    ...
                    <input type="button" value="ir a la tienda" class="btnCrearCuenta">
                </div>
                ...
                <div class="box">
                    ...
                    <img src="img/BolsitosKio.jpg" alt="" class="foto-normal">
                    <!-- imagen -->
                    <div class="inner-container texto">
                        ...
                        <div class="inner-box">
                            <ul>
                                ...
                                <li>Llaveros y accesorios samrio</li>
                            </ul>
                        </div>
                    </div>
                    <input type="button" value="ir a la tienda" class="btnCrearCuenta">
